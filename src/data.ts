...
export const listings: Listing[] = [
  { id: 'l1', name: 'Charizard ex - Special Illustration Rare', set: 'Paldean Fates', number: '239/091', condition: 'NM', grade: 'PSA 10', price: 320, seller: 'HialeahCards', rating: 4.9, sales: 312, distance: 2.4, area: 'South Beach, FL', game: 'Pokemon', image: cardImg(326312), raw: false },
  { id: 'l2', name: 'Pikachu V - Rainbow Rare', set: 'Celebrations', number: '025/025', condition: 'LP', price: 78, seller: 'MiaCardCo', rating: 4.7, sales: 88, distance: 5.1, area: 'Miami, FL', game: 'Pokemon', image: cardImg(326311), raw: true },
  { id: 'l3', name: 'Mewtwo VSTAR - Gold Secret', set: 'Crown Zenith', number: 'GG70', condition: 'NM', grade: 'BGS 9.5', price: 145, seller: 'GablesTCG', rating: 5.0, sales: 421, distance: 8.8, area: 'Coral Gables, FL', game: 'Pokemon', image: cardImg(326310), raw: false },
  { id: 'l4', name: 'Umbreon VMAX - Alt Art', set: 'Evolving Skies', number: '215/203', condition: 'NM', grade: 'PSA 10', price: 410, seller: 'NightShift', rating: 4.8, sales: 156, distance: 12.3, area: 'Hialeah, FL', game: 'Pokemon', image: cardImg(326309), raw: false },
  { id: 'l5', name: 'Lugia V - Alt Art', set: 'Silver South Beachst', number: '215/195', condition: 'NM', price: 64, seller: 'BiscayneCards', rating: 4.6, sales: 42, distance: 3.2, area: 'South Beach, FL', game: 'Pokemon', image: cardImg(326308), raw: true },
  { id: 'l6', name: 'Giratina VSTAR - Alt Art', set: 'Lost Origin', number: '212/196', condition: 'MP', price: 92, seller: 'LostEcho', rating: 4.5, sales: 19, distance: 15.0, area: 'Little Haiti, FL', game: 'Pokemon', image: cardImg(326307), raw: true },
];
...
export const myListings: MyListing[] = [
  ...
  { id: 'm5', name: 'Lugia V - Alt Art', set: 'Silver South Beachst', condition: 'Raw NM', price: 64, status: 'live', views: 388, saves: 9, offers: 1, image: cardImg(326308) },
];

export const conversations: Conversation[] = [
  {
    id: 'c1', name: 'HialeahCards', role: 'selling', avatar: 'M', last: 'Meetup confirmed for Sat 2pm at Bayside Marketplace', time: '2m', status: 'meetup', autopilot: true,
    messages: [
      ...
      { from: 'ai', text: "I can accept $305 and meet at Bayside Marketplace this weekend.", time: '10:05' },
      { from: 'them', text: 'Deal. Saturday 2pm works.', time: '10:06' },
      { from: 'ai', text: 'Meetup confirmed for Sat 2pm at Bayside Marketplace. I\'ll send a pin.', time: '10:06' },
    ],
  },
  {
    id: 'c2', name: 'MiaCardCo', role: 'buying', avatar: 'A', last: 'AI is negotiating your offer of $70', time: '14m', status: 'negotiating', autopilot: true,
    messages: [
      { from: 'me', text: 'I can do $70 for the Pikachu V rainbow.', time: '9:30' },
      { from: 'ai', text: 'Sent offer of $70 to MiaCardCo. Awaiting response.', time: '9:30' },
      { from: 'them', text: '$75 and I\'ll throw in a sleeve.', time: '9:34' },
      { from: 'ai', text: 'Countering at $72 with meetup in Miami.', time: '9:34' },
    ],
  },
  {
    id: 'c3', name: 'GablesTCG', role: 'selling', avatar: 'D', last: 'Awaiting seller response on meetup', time: '1h', status: 'awaiting', autopilot: false,
    messages: [
      { from: 'them', text: 'Interested in the Mewtwo. Can you ship?', time: '8:10' },
      { from: 'me', text: 'Local meetup only, sorry.', time: '8:12' },
      { from: 'them', text: 'How about Dolphin Mall?', time: '8:14' },
    ],
  },
  {
...
export const priceCards: PriceCard[] = [
  ...
  { id: 'p5', name: 'Lugia V - Alt Art', set: 'Silver South Beachst', number: '215/195', lang: 'EN', grade: 'Raw', price: 64, change: 12.5, volume: 51, image: cardImg(326308), trend: [50,52,55,53,56,58,60,62,63,64,66,64] },
...
export const ownedCards: OwnedCard[] = [
  ...
  { id: 'o4', name: 'Lugia V - Alt Art', set: 'Silver South Beachst', grade: 'Raw', copies: 2, avgCost: 55, value: 64, image: cardImg(326308) },
];
...
export const oracles: Oracle[] = [
  {
    ...
    confidence: 78, horizon: '12 months', reasoning: 'Charizard SIR supply is tightening while PSA 10 population growth slows. Local demand in the Miami metro has outpaced new listings for 6 straight weeks.',
  ...
  {
    id: 'or3', name: 'Lugia V - Alt Art', set: 'Silver South Beachst', grade: 'Raw', current: 64,
    forecast: [{ label: 'Current', value: 64, delta: 0 }, { label: '3M', value: 72, delta: 12.5 }, { label: '1Y', value: 95, delta: 48.4 }],
    confidence: 71, horizon: '12 months', reasoning: 'Silver South Beachst is out of print and Lugia alt art raw copies are disappearing from local markets. Grading upside is significant.',
...
export const threads: Thread[] = [
  ...
  { id: 't2', title: 'Anyone else seeing Lugia alt arts dry up locally?', author: 'BiscayneCards', avatar: 'V', time: '5h', votes: 27, comments: 11, tags: ['Local', 'Lugia'], preview: 'Three meetups this week and zero raw Lugia alts. Are we out of Silver South Beachst supply?', type: 'local' },
  { id: 't3', title: 'PSA 10 vs BGS 9.5 — which moves faster in Miami?', author: 'GablesTCG', avatar: 'D', time: '8h', votes: 19, comments: 24, tags: ['Grading', 'Discussion'], preview: 'I\'ve noticed PSA 10 listings sell ~30% faster locally. Anyone tracking this?', type: 'general' },
  ...
  { id: 't5', title: 'South Beach meetup recap — best pulls of the weekend', author: 'HialeahCards', avatar: 'M', time: '1d', votes: 54, comments: 9, tags: ['Local', 'Pulls'], preview: 'Saw a live Charizard SIR pull at the swap meet. Crowd went wild.', type: 'local' },
  { id: 't6', title: 'Best meetup spots in the Little Havana?', author: 'MiaCardCo', avatar: 'A', time: '2d', votes: 15, comments: 21, tags: ['Local', 'Meetup'], preview: 'Bayside Marketplace feels safest for high-value trades. Anyone prefer elsewhere?', type: 'general' },
];
